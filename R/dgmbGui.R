...
cat ("| Version: Beta 1.0                               |\n")                                 
cat ("| Depends: abind, tcltk, MASS                     |\n")
cat ("| Licence: GPL version 2                          |\n")
cat ("| System Requirements: tktable                    |\n")
cat (" -------------------------------------------------\n")
...
tktitle(tt) <- "dgmb: Simulating data for PLS structural models (Beta 1.0)"
topMenu <- tkmenu(tt)
...
#About Menu
tkadd(AcercadeMenu,"command",label="Version",command = function () tkmessageBox(title="Version",message="dgmbGui (Beta 1.0)", icon="info", type="ok"))
